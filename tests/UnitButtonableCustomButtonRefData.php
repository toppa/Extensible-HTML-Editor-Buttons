...
class UnitButtonableCustomButtonRefData extends UnitTestCase {
    ...
    public function testGetRefData() {
        ...
        $customButtonRefData = new ButtonableCustomButtonRefData();
        $refData = $customButtonRefData->getRefData();
        $this->assertEqual($expectedRefData, $refData);
    }
}
